...
type SignUpInForm = z.infer<typeof signupInForm>
...
export function SignUp() {
  ...
  } = useForm<SignUpInForm>()

  async function handleSignUpIn(data: SignUpInForm) {
    try {
      console.log(data)
    ...
    <>
      ...
      <div className="p-8">
        <div className="flex w-[350px] flex-col justify-center gap-6">
          ...
          <form onSubmit={handleSubmit(handleSignUpIn)} className="space-y-4">
